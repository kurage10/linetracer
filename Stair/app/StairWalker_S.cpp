  ...
  namespace app{
	...
	mState=PREPARE_TURNING;
      ...
      */
      ...
      if((mObstacleDitector->isDistance(228) && !mObstacleDitector->isDistance(232)) || timefromstart > 0){
      	...
      	int speed = mObstacleDitector->calcSpeed(230);
